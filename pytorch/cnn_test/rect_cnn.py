...
def train_model(width,height,torch_datas,torch_labels):
...
if __name__ == "__main__":
    ...
    for i in range(count):
        ...
        s = format("%d-%d"%(torch_labels[i],max_index))
        print(s)
